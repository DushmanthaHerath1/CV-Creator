...
## Date: 12/01/2026 at 04.53AM

### key Updates

**Enhanced responsiveness of the enitre application including the landing page**
**Installed new package rect helmet provider**
...
- `src/components/preview/VCPreview.jsx`
...
## Date: 12/01/2026 at 09.57PM

## key updates

**replace window.confirm() message which is out dated to modern dialog box. to popup when user tried to remove an secrion from his CV**
...
## Date: 12/01/2026 at 03.52AM

## key updates

**created template library and roughly tested. woking properly**
**cleaned up folder sturcture a bit**

```text
src/
├── components/
│   ├── form/                # 📝 FORM INPUT SECTIONS
│   │   ├── BioSection.jsx
│   │   ├── Experience.jsx
│   │   ├── Education.jsx
│   │   └── ... (Skills, Projects, etc.)
│   ├── preview/             # 👁️ PREVIEW ENGINE
│   │   └── CVPreview.jsx    (The PDF Viewer Container)
│   ├── ui/                  # 🎨 SHARED UI
│   │   ├── ConfirmDialog.jsx (Glassmorphism Alert)
│   │   └── SortableSection.jsx (Drag & Drop Wrapper)
│   ├── HeaderSection.jsx
│   └── TemplateGallery.jsx  # 🆕 Template Picker Modal
│
├── pdf/                     # 📄 PDF LOGIC
│   ├── templates/           # 🎨 TEMPLATE DESIGNS
│   │   ├── index.js         (Registry / Config)
│   │   ├── ModernTemplate.jsx (Blue/Sidebar style)
│   │   └── MinimalTemplate.jsx (ATS/Black & White style)
│   └── CVDocument.jsx       (The Logic Switcher)
│
├── pages/
│   └── BuilderPage.jsx      (Main Controller / State Hub)
│
├── schemas/
│   └── cvSchema.js          (Zod Validation + templateId field)
│
└── db.js                    (IndexedDB/LocalStorage Logic)

```

## Updated and newly created components and other files

- `src/schemas/cvSchema.js`
...
- `src/components/pdf/templates/MinimalTemplate.jsx`
...
- `src/components/pdf/templates/ModernTemplate.jsx`
  ``jsx
  import React from "react";
  import {
  Page,
